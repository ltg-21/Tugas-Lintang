...
def case1():
    ...
    def input_data_mahasiswa():
        clear_screen()
        mahasiswa_list = []
        jumlah_mahasiswa = int(input("Masukkan jumlah mahasiswa yang ingin Anda input: "))
...
def main():
    ...
    while True:
        ...
        print("4. Keluar")
        pilihan = input("Silahkan pilih kasus: ")
        ...
        if pilihan == '1':
            ...
            print("Pilihan tidak valid. Harap memilih studi kasus no. 1-4. Silakan pilih lagi.")
